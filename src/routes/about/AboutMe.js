  ...
  return (
    <section>
      ...
      <p className="white-text p-tag">
        I am a front-end web developer with 1 years of working experience. I
        combine my Web Design ideas with technical skills and fully commit
        ...
        responsive websites using HTML, CSS, Vanilla JavaScript,React Bootstrap and React. 
